...
|---|------|------|------|------|------|--------|----------|------|--------|------|--------|------|----------|
| 1 | 5/25 | 🔴空 | 77,580 | 74,900 | 46 | $11.90 | 78,406 | $12.33 | $0.35 | **$11.98** | +100.7% | 1天19h | 止盈触发 |
| 2 | 5/27 | 🔴空 | 75,054 | 70,924 | 76 | $19.01 | 76,935 | $31.39 | $0.56 | **$30.83** | +162.2% | 5天19h | 移动止损 |
| 3 | 6/02 | 🔴空 | 67,998 | 63,392 | 166 | $37.63 | 70,425 | $76.46 | $1.09 | **$75.37** | +200.3% | 1天12h | 移动止损 |
| 4 | 6/04 | 🔴空 | 64,370 | 62,570 | 386 | $82.82 | 65,387 | $69.47 | $2.45 | **$67.02** | +80.9% | 22.5h | 回测结束 |

> 📐 计算公式按 [MGBX 官方文档](https://support.mgbx.com/hc/zh-cn/articles/10037172478095)：
> 空仓盈亏 = (开仓均价 − 平仓价) × 张数 × 0.0001（面值）
> 保证金 = 名义价值 ÷ 30x（50×60%）
> 回报率 = 净利 ÷ 保证金
> 手续费 = 名义价值 × 0.05%（Taker）× 2（开+平）
> 4H 从 5/25 起判定为持续 DOWN，15 分钟只做「涨不动就空」。
> 单边暴跌 17% 的市场中，反向赚了 926%。
